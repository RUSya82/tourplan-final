...
/* harmony import */ var _modules_slidersInit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/slidersInit */ "./app/js/modules/slidersInit.js");
/* harmony import */ var _modules_menuToggle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/menuToggle */ "./app/js/modules/menuToggle.js");
/* harmony import */ var _modules_formListener__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/formListener */ "./app/js/modules/formListener.js");
/* harmony import */ var _modules_maskInput__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/maskInput */ "./app/js/modules/maskInput.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var modal = Object(_modules_modal__WEBPACK_IMPORTED_MODULE_0__["default"])({
    modal: modalPopup
  }); //init toggle menu

  Object(_modules_menuToggle__WEBPACK_IMPORTED_MODULE_2__["default"])(); //init send form

  Object(_modules_formListener__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_maskInput__WEBPACK_IMPORTED_MODULE_4__["default"])();
  aos__WEBPACK_IMPORTED_MODULE_6___default.a.init(); //init sliders

  Object(_modules_slidersInit__WEBPACK_IMPORTED_MODULE_1__["default"])();
});

/***/ }),

/***/ "./app/js/modules/bindForm.js":
/*!************************************!*\
  !*** ./app/js/modules/bindForm.js ***!
  \************************************/
...
/* harmony import */ var _validator__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./validator */ "./app/js/modules/validator.js");
...
var bindForm = function bindForm(form, callback) {
  ...
  var formSender = function formSender(targetForm, validObject) {
    var postData = function postData(body) {
      return fetch('send.php', {
        body: body,
        method: 'POST'
    ...
    targetForm.addEventListener('submit', function (e) {
      ...
      if (!validObject.init()) {
        ...
        postData(JSON.stringify(data)).then(function (response) {
  ...
  var phoneField = form.querySelector('.user-phone');
  var nameField = form.querySelector('.user-name');
  var message = form.querySelector('.user-message');
  ...
  formSender(form, new _validator__WEBPACK_IMPORTED_MODULE_8__["default"](form, initArray));
};

/* harmony default export */ __webpack_exports__["default"] = (bindForm);

/***/ }),

/***/ "./app/js/modules/formListener.js":
/*!****************************************!*\
  !*** ./app/js/modules/formListener.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _bindForm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bindForm */ "./app/js/modules/bindForm.js");
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modal */ "./app/js/modules/modal.js");
...
var formListener = function formListener() {
  ...
  var modalPopup = document.querySelector('.modal');
  var modal = Object(_modal__WEBPACK_IMPORTED_MODULE_1__["default"])({
    modal: modalPopup
  });

  if (feedBackForm) {
    Object(_bindForm__WEBPACK_IMPORTED_MODULE_0__["default"])(feedBackForm, function () {
      window.location.assign('thanks.html');
    });
  }

  if (subscribeForm) {
    Object(_bindForm__WEBPACK_IMPORTED_MODULE_0__["default"])(subscribeForm, function () {
      window.location.assign('thanks.html');
    });
  }

  if (modalForm) {
    Object(_bindForm__WEBPACK_IMPORTED_MODULE_0__["default"])(modalForm, function () {
      window.location.assign('thanks.html');
      modal.closeModal();
    });
  }
...
/* harmony default export */ __webpack_exports__["default"] = (formListener);

/***/ }),

/***/ "./app/js/modules/maskInput.js":
/*!*************************************!*\
  !*** ./app/js/modules/maskInput.js ***!
  \*************************************/
/*! exports provided: maskInputs, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "maskInputs", function() { return maskInputs; });
/* harmony import */ var core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.for-each */ "./node_modules/core-js/modules/es.array.for-each.js");
/* harmony import */ var core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _maskPhone__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./maskPhone */ "./app/js/modules/maskPhone.js");





var maskInputs = function maskInputs() {
  var emailInputs = document.querySelectorAll('.user-email');
  var messageInputs = document.querySelectorAll('.user-message');
  var nameInputs = document.querySelectorAll('.user-name');
  Object(_maskPhone__WEBPACK_IMPORTED_MODULE_4__["default"])('.user-phone');
  emailInputs.forEach(function (item) {
    item.addEventListener('input', function (e) {
      return e.target.value = e.target.value.replace(/[^a-z@0-9\-._]/ig, '');
    });
  });
  messageInputs.forEach(function (item) {
    item.addEventListener('input', function (e) {
      return e.target.value = e.target.value.replace(/[^a-zа-я.,\- 0-9]/ig, '');
    });
  });
  nameInputs.forEach(function (item) {
    item.addEventListener('input', function (e) {
      return e.target.value = e.target.value.replace(/[^a-zа-я.,\- ]/ig, '');
    });
  });
};
/* harmony default export */ __webpack_exports__["default"] = (maskInputs);

/***/ }),

/***/ "./app/js/modules/maskPhone.js":
/*!*************************************!*\
  !*** ./app/js/modules/maskPhone.js ***!
  \*************************************/
/*! exports provided: default */
...
/***/ "./app/js/modules/menuToggle.js":
/*!**************************************!*\
  !*** ./app/js/modules/menuToggle.js ***!
  \**************************************/
/*! exports provided: menuToggle, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var Modal = /*#__PURE__*/function () {
  function Modal(_ref) {
    var modal = _ref.modal,
        _ref$buttonsClassName = _ref.buttonsClassName,
        buttonsClassName = _ref$buttonsClassName === void 0 ? 'modal-activator' : _ref$buttonsClassName,
        _ref$modalActiveClass = _ref.modalActiveClass,
        modalActiveClass = _ref$modalActiveClass === void 0 ? 'modal--active' : _ref$modalActiveClass,
        _ref$modalContentClas = _ref.modalContentClass,
        modalContentClass = _ref$modalContentClas === void 0 ? 'modal-content' : _ref$modalContentClas,
        _ref$buttonCloseClass = _ref.buttonCloseClass,
        buttonCloseClass = _ref$buttonCloseClass === void 0 ? 'modal-close' : _ref$buttonCloseClass,
        _ref$useEscape = _ref.useEscape,
        useEscape = _ref$useEscape === void 0 ? true : _ref$useEscape,
        _ref$useFadeCLose = _ref.useFadeCLose,
        useFadeCLose = _ref$useFadeCLose === void 0 ? true : _ref$useFadeCLose;
  ...
  _createClass(Modal, [{
    ...
    value: function addListener() {
      ...
      this.modalActivators.forEach(function (activator) {
      ...
      this.modal.addEventListener('click', function (e) {
        ...
        if (_this.useFadeCLose) {
          isModal = e.target.closest(".".concat(_this.modalContentClass));
        } else {
          isModal = true;
        }

        var isCloseBtn = e.target.closest(".".concat(_this.buttonCloseClass));
    ...
    key: "toggleLockBody",
    value: function toggleLockBody() {
      var body = document.body;
      body.classList.toggle('lock');
      var bodyScroll = this.calcScroll();

      if (body.classList.contains('lock')) {
        body.style.marginRight = "".concat(bodyScroll, "px");
      } else {
    ...
    key: "modalGetInstance",
    value: function modalGetInstance() {
      var data = [];
      return function (params) {
        var object = data.find(function (item) {
          return item.modal === params.modal;
        });
        console.log(object);
...
var modalInstance = Modal.modalGetInstance();
/* harmony default export */ __webpack_exports__["default"] = (modalInstance);

/***/ }),

/***/ "./app/js/modules/slidersInit.js":
/*!***************************************!*\
  !*** ./app/js/modules/slidersInit.js ***!
  \***************************************/
/*! exports provided: slidersInit, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var slidersInit = function slidersInit() {
  var hotelSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.hotel-slider__container', {
    // Optional parameters
    loop: true
  });
  var hotelSliderButtonNext = document.querySelector('.hotel-slider__arrow--next');

  if (hotelSliderButtonNext) {
    hotelSliderButtonNext.addEventListener('click', function (e) {
      hotelSwiper.slideNext(500);
    });
  }

  var hotelSliderButtonPrev = document.querySelector('.hotel-slider__arrow--next');

  if (hotelSliderButtonPrev) {
    hotelSliderButtonPrev.addEventListener('click', function (e) {
      hotelSwiper.slidePrev(500);
    });
  }

  var reviewsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.reviews-slider__container', {
    // Optional parameters
    loop: true,
    centeredSlides: true,
    slidesPerView: 1,
  ...
  var reviewsSliderButtonNext = document.querySelector('.reviews-slider__button--next');

  if (reviewsSliderButtonNext) {
    reviewsSliderButtonNext.addEventListener('click', function (e) {
      reviewsSwiper.slideNext(500);
    });
  }

  var reviewsSliderButtonPrev = document.querySelector('.reviews-slider__button--prev');

  if (reviewsSliderButtonPrev) {
    reviewsSliderButtonPrev.addEventListener('click', function (e) {
  ...
  _createClass(Validator, [{
    ...
    value: function showErrors() {
      this.errors.forEach(function (item) {
        ...
        var message = item.element.parentNode.querySelector('.error-message');
    ...
    value: function checkIt(_ref) {
      ...
      if (type === 'text') {
        if (pattern) {
          ...
          if (this.getPattern(method) && !this.getPattern(method).test(_value)) {
            this.errors.add({
              element: element,
              pattern: pattern,
              method: method
